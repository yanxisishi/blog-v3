...
我是把博客本体部署在了 WSL2 上面，用 vscode 连接进行管理，下列的命令在终端执行即可。（别给误导了，博客本体部署在 D 盘也可以...）
...
博客或者各种笔记中的图片怎么储存一直是个问题，我更倾向于搭建图床，尤其是用 Cloudflare R2 搭建图床，每月10 GB存储和1000万次读取，一个个人博客根本用不完。
