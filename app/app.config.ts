...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ph:github-logo-bold', text: 'GitHub: yanxisishi', url: 'https://github.com/yanxisishi' },
		...
		nav: [
			...
			// },
			{
				title: '社交',
				items: [
					{ icon: 'ph:github-logo-bold', text: 'yanxisishi', url: 'https://github.com/yanxisishi' },
